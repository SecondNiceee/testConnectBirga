...
const MyReaction = ({ openAboutReactionFunc, responce, setSliderActive, deleteFunction, agree = false }) => {
  return (
    <>
      <div className="reaction">
        ...
        <div className="reaction__middle" style={{
          marginBottom : "18px"
        }}>
          <img onClick={() => {
