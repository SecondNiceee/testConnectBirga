...
const CreateInput = forwardRef(({className , value , setValue , type , inputMode, mistake = false,   ...props }, ref) => {
    return (
        <input maxLength={20} style={mistake ? {border : "1px solid #fe6766", color : "#fe6766" } : {}} ref={ref} inputMode={inputMode} spellCheck="false" autoComplete="off" value={value} onChange={(e) => {
