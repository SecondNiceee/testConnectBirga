...
const MyDatePicker = ({ className, taskInformation, setTaskInformation, GreyIntWidth, GreyWidth, setState, state , errors, ...props}) => {
  ...
  return (
    ...
    >
      ...
      />
      <CatchDate
       className={cl.CatchDate} whichOne={whichOne} state={state} setState = {setState} errors = {errors} />
    </div>
  );
};
