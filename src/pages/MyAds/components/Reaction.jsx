...
const Reaction = ({ setOpen, put, openAboutReactionFunc, responce, setSliderActive, agree = false }) => {
  return (
    <>
...
<FalseTie agree = {agree} navigate={"responce"} task={responce} id={responce.id} />
    </div>
      }
