...
const ChoiceCategory = ({
  ...
  return (
    <div className={cl.ChoiceCategory} {...props}>
      ...
      <p className="mt-[31px] ml-[17px] font-sf-pro-display font-light text-[13px] tracking-[0.02em] text-[#84898f] uppercase mb-[10px] trac ">КАТЕГОРИИ</p>
            ...
            {myFilteredCategory.map((category, id) => {
              return (
                <div onClick={categoryClickHandler(category)} className="grid cursor-pointer pt-[10px] grid-cols-[min-content_auto] gap-y-[10px] gap-x-[11px] w-full">
                  <div className={`rounded-full border-solid  border-[#384656] border-[1px] w-[21px] h-[21px] self-center flex justify-center items-center ${choisenCategory?.id === category.id ? "bg-[#2EA6FF] " : ""}`}>
                  ...
                  <div className="flex flex-col gap-[4px]">
                    <h3 className="font-light  text-[17px] text-white font-sf-pro-text leading-[17px]">{category.category}</h3>
