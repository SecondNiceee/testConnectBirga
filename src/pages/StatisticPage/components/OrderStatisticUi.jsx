...
const OrderStatisticUi = ({userConfig}) => {
            ...
            <div className="flex flex-col rounded-[12px] bg-[#20303f]">
                {orderStatistics.map((e, i) => (
                        <div className={`flex cursor-pointer flex-col pt-[8px] `}>
                            ...
                            <div className={`${i !== orderStatistics.length-1 ? 'opacity-1' : 'opacity-0'} w-[calc(100%-19px)] mt-[8px] h-[0.5px] ml-auto bg-[#384656]`}></div>
                        </div>
                ))}
            </div>
...
export default OrderStatisticUi;