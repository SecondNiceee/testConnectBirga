...
const BaidgeWithoutProfile = ({ userInfo, setUserInfo,className }) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-[11.667px] mx-auto font-sf-pro-display leading-[12.535px] tracking-[0.117px] text-[#95979E] mt-[11.67px]">На Connect с {formatDate(new Date(userInfo.createdAt))}</p>
    </div>
  );
};
