...
const GoToMessageButton = ({link, className}) => {
  return (
    <div onClick={() => {openLink(`https://t.me/${link}`)}} className={`w-full cursor-pointer py-[17px] justify-center items-center gap-1 flex bg-telegram rounded-[11.67px] ${className}`}>
